...
export default function Login() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-6 py-16">
      ...
      <p className="mt-2 text-sm text-cream/50">Log in to keep harvesting.</p>
      ...
      <p className="mt-6 text-center text-sm text-cream/50">
        No account yet? <Link to="/register" className="text-accent2 hover:underline">Start free</Link>
      </p>
    </div>
  );
}
